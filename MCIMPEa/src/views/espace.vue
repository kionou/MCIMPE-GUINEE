                    ...
                    <div class="col-sm-12 md:w-100 col-lg-4 d-flex mb-4">
                        <div class="card w-100 card-round scard">
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="row mt-2">
                                    <div class="col-sm-12"><b class="" style="color: var(--color-primary);">Mon profil (Entreprise) </b>
                                        <p class="py-3 mb-2">Gérez votre profil en toute simplicité</p>
                                        
                                    </div>
                                </div>
                                <div class="mt-auto text-center">
                               <router-link to="/#" class="btnLogin" >Modifier</router-link>
                            </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 md:w-100 col-lg-4 d-flex mb-4">
                        <div class="card w-100 card-round scard">
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="row mt-2">
                                    <div class="col-sm-12"><b class="" style="color: var(--color-primary);">Gestion </b>
                                    <p class="py-3 mb-2">Sauvegardez vos documents, images et vidéos ici</p>
                                   
                                </div>
                            </div>
                            <div class="mt-auto text-center">
                               <router-link class="btnLogin" to="/#">Ajouter</router-link>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 md:w-100 col-lg-4 d-flex mb-4">
                    <div class="card w-100 card-round scard">
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="row mt-2">
                                <div class="col-sm-12"><b class="" style="color: var(--color-primary);">Mon profil (Personnel)</b>
